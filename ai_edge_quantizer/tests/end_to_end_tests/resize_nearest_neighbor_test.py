...
"""E2E tests for the quantizer for model with resize nearest neighbor."""
...
class ResizeNearestNeighborTest(test_utils.BaseOpTestCase):

  def setUp(self):
    super().setUp()
    self._op_name = qtyping.TFLOperationName.RESIZE_NEAREST_NEIGHBOR
  ...
  def test_static_quantization_accuracy_and_size_within_tolerance(
    ...
    output_tolerance = 5e-5
    model_filename = 'single_resize_nearest_neighbor.tflite'

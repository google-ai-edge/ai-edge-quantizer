...
"""E2E tests for the quantizer for model with rsqrt op."""
...
def _get_calibration_data(num_samples: int = 512):
...
class RsqrtTest(parameterized.TestCase):
  ...
  def test_rsqrt_model_full_integer(self, recipe_path):

...
"""E2E tests for the quantizer for model with padv2."""
...
class PadV2Test(test_utils.BaseOpTestCase):

  def setUp(self):
    super().setUp()
    self._op_name = qtyping.TFLOperationName.PADV2
  ...
  def test_static_quantization_accuracy_and_size_within_tolerance(
    ...
    # Model size increases due to q-dq inserted around the padv2 op.
    expected_model_size_reduction = -40

    model_filename = 'single_padv2.tflite'

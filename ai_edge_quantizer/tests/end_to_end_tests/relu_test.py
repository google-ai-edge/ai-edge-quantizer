...
"""E2E tests for the quantizer for model with relu op."""
...
class ReluTest(test_utils.BaseOpTestCase):

  def setUp(self):
    super().setUp()
    self._op_name = qtyping.TFLOperationName.RELU
  ...
  def test_static_quantization_accuracy_within_tolerance(
    ...
    model_filename = 'single_relu.tflite'

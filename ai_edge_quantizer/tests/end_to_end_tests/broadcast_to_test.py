...
"""E2E tests for the quantizer for model with broadcast_to op."""
...
class BroadcastToTest(test_utils.BaseOpTestCase):

  def setUp(self):
    super().setUp()
    self._op_name = qtyping.TFLOperationName.BROADCAST_TO
  ...
  def test_static_quantization_accuracy_and_size_within_tolerance(
    ...
    model_filename = 'single_broadcast_to.tflite'

...
"""E2E tests for the quantizer for model with hard_swish op."""
...
class HardSwishTest(test_utils.BaseOpTestCase):

  def setUp(self):
    super().setUp()
    self._op_name = qtyping.TFLOperationName.HARD_SWISH
  ...
  def test_static_quantization_accuracy_and_size_within_tolerance(
    ...
    model_filename = 'single_hard_swish.tflite'

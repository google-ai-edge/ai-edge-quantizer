...
"""E2E tests for the quantizer for model with equal op."""
...
class EqualTest(test_utils.BaseOpTestCase):

  def setUp(self):
    super().setUp()
    self._op_name = qtyping.TFLOperationName.EQUAL
  ...
  def test_static_quantization_accuracy_within_tolerance(
    ...
    model_filename = 'single_equal.tflite'

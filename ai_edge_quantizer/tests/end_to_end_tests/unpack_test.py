...
"""E2E tests for the quantizer for model with unpack op."""
...
class UnpackTest(test_utils.BaseOpTestCase):

  def setUp(self):
    super().setUp()
    self._op_name = qtyping.TFLOperationName.UNPACK
  ...
  def test_static_quantization_accuracy_and_size_within_tolerance(
    ...
    model_filename = 'single_unpack.tflite'

...
2. `quantization/oscar_conditioner.py`: The second part of OSCAR (SmoothQuant 
   style equivalent transform). This is a whole-graph conditioning pass that
   folds per-input-channel scales into upstream producers, running *before* 
   quantization.

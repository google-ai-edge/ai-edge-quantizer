...
class OscarTest(parameterized.TestCase):
  ...
  def test_calibrate_computes_correct_mu2(self):
    ...
    tensor_content_map = {'input': x, 'output': 2.0 * x}
    self.enter_context(
        mock.patch.object(
    ...
    # The reshaped input is [[1, 2, 3], [4, 5, 6]].
    # The element-wise squared matrix is [[1, 4, 9], [16, 25, 36]].
    # Taking the mean across the batch dimension (axis=0) gives:
    #   [(1+16)/2, (4+25)/2, (9+36)/2] = [8.5, 14.5, 22.5].

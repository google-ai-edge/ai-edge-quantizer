...
def get_tensor_quant_params(
  ...
  # The code is borrowed from Gemma quantization:
  # //depot/learning/gemini/gemma/core/compression/weight_algorithms/mse_quant_weight.py
  ...
  print("Processing weight tensor using MSE quantization.")

...
class ReshapeTest(op_test_utils.BaseQuantizeTest):
  ...
  def test_materialize_reshape_succeeds(
    ...
    op_info = qtyping.OpInfo(
        op=op,
        op_name=qtyping.TFLOperationName.RESHAPE,
    ...
    self._test_no_weights_op(
        ...
        self._graph_info,
        self._op_test_info,
        common_quantize.materialize_reshape,
        get_tensor_quant_params_func,

...
class SubTest(op_test_utils.BaseQuantizeTest):
  ...
  def test_materialize_srq_sub_succeeds(self, test_case):
  ...
  def test_materialize_srq_sub1_constant_input_succeeds(self, test_case):

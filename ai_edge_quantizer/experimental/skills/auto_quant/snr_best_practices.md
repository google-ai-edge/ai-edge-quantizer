...
## 2. Standard Loop for Identifying Sensitive Layers
...
## 3. Boilerplate: Extracting SNR from Validation Results
...
## 4. Boilerplate: Abstracting the Regex (Preventing Huge Strings)

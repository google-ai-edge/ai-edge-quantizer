...
class Calibrator:
  ...
  def get_total_operations(self, calibration_dataset) -> int:
  ...
  def calibrate(
    ...
    total_ops = self.get_total_operations(calibration_dataset)
    with progress_utils.ProgressBar(
      ...
      for signature_key, dataset in calibration_dataset.items():
        ...
        for data in dataset:
          # Initialize tensor names updated in this calibration round.

...
from quantization_toolkit import transformation_instruction_generator as instruction_generator
...
class InstructionGeneratorTest(parameterized.TestCase):
  ...
  def test__apply_vertical_optimization(
    ...
    ins_gen = instruction_generator.TransformationInstructionsGenerator(
        os.path.join(TEST_DATA_PREFIX_PATH, "test_models/single_fc_bias.tflite")
    )
